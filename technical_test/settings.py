...
SECRET_KEY = 'django-insecure-e!%ywku9=1b)1abit*g!uh6*qll(2tyyf3_v2r$zneh!jvr)1g'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['0.0.0.0', 'localhost', '127.0.0.1', 'your-domain.com', 'your-other-domain.com']
...
MIDDLEWARE = [
    ...
    # 'rest_framework_api_key.middleware.APIMiddleware',
